...
import {getEmployeeJobInfo,saveEmployeeJobInfo,getEmployeeSimpleListApi} from '@/api/employees'
export default {
  name: "JobInfo",
  ...
  methods: {
    async initData(){
       const data =  await getEmployeeJobInfo(this.userId)
       this.depts = await getEmployeeSimpleListApi()
       this.formData = data
    },
    async saveJob(){
